...
  const API_BASE_URL = "[https://harideeshab-pharma-sales-api.hf.space](https://harideeshab-pharma-sales-api.hf.space)";
  
...
                      <button className="ai-button" onClick={handleGenerateGeminiSummary} disabled={isGeminiSummaryLoading || !historicalSummaryText || !forecastSummaryText}>
...
                        disabled={isAiChatLoading || !historicalSummaryText || !forecastSummaryText}
                      />
                      <button type="submit" disabled={isAiChatLoading || !historicalSummaryText || !forecastSummaryText}>
                        <Send />
                      </button>
                    </form>
                  </div>
